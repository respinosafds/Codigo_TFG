...
df_true = pd.read_csv("RealNews.csv")
...
df = df_merge.drop(["id","verifiable","label","evidence"], axis = 1)
...
#Bucle que lee noticias hasta que el usuario pulse la tecla "Enter"
while True:
...
news11 = str(input("\n\n\nIntroduce el texto de la noticia:"))
manual_testing(news11)

news12 = str(input("\n\n\nIntroduce el texto de la noticia:"))
manual_testing(news12)

news13 = str(input("\n\n\nIntroduce el texto de la noticia:"))
manual_testing(news13)

news14 = str(input("\n\n\nIntroduce el texto de la noticia:"))
manual_testing(news14)

news15 = str(input("\n\n\nIntroduce el texto de la noticia:"))
manual_testing(news15)

news16 = str(input("\n\n\nIntroduce el texto de la noticia:"))
manual_testing(news16)

news17 = str(input("\n\n\nIntroduce el texto de la noticia:"))
manual_testing(news17)

news18 = str(input("\n\n\nIntroduce el texto de la noticia:"))
manual_testing(news18)

news19 = str(input("\n\n\nIntroduce el texto de la noticia:"))
manual_testing(news19)

news20 = str(input("\n\n\nIntroduce el texto de la noticia:"))
manual_testing(news20)
'''